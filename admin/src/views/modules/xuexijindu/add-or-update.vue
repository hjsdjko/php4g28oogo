	...
	<div class="addEdit-block" :style='{"padding":"30px","fontSize":"16px","color":"#666","background":"none"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="textarea" v-if="type!='info'" label="进度详情" prop="jinduxiangqing">
					<el-input
					  style="min-width: 200px; max-width: 600px;"
					  type="textarea"
					  :rows="8"
					  placeholder="进度详情"
					  v-model="ruleForm.jinduxiangqing" >
					</el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else-if="ruleForm.jinduxiangqing" label="进度详情" prop="jinduxiangqing">
					<span :style='{"fontSize":"16px","lineHeight":"40px","color":"inherit","fontWeight":"500","display":"inline-block"}'>{{ruleForm.jinduxiangqing}}</span>
				</el-form-item>
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='jinduxiangqing'){
							this.ruleForm.jinduxiangqing = obj[o];
							this.ro.jinduxiangqing = true;
							continue;
						}
				}
...
var objcross = this.$storage.getObj('crossObj');
      ...
      if(objcross!=null) {
		  if(!this.ruleForm.jifen){
			  this.$message.error("积分不能为空");
			  return
		  }
	      objcross.jifen = parseFloat(objcross.jifen) + parseFloat(this.ruleForm.jifen)
                }
