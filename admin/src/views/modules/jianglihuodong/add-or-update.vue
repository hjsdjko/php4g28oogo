<template>
	<div class="addEdit-block" :style='{"padding":"30px","fontSize":"16px","color":"#666","background":"none"}'>
		...
		>
			<template >
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'" label="活动编号" prop="huodongbianhao">
					<el-input v-model="ruleForm.huodongbianhao" placeholder="活动编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-else-if="ruleForm.huodongbianhao" label="活动编号" prop="huodongbianhao">
					<el-input v-model="ruleForm.huodongbianhao" placeholder="活动编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="活动标题" prop="huodongbiaoti">
					<el-input  v-model="ruleForm.huodongbiaoti" placeholder="活动标题" clearable  :readonly="ro.huodongbiaoti"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="活动标题" prop="huodongbiaoti">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="所需积分" prop="jifen">
					<el-input  v-model.number="ruleForm.jifen" placeholder="所需积分" clearable  :readonly="ro.jifen"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="所需积分" prop="jifen">
					<el-input v-model="ruleForm.jifen" placeholder="所需积分" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="活动人数" prop="huodongrenshu">
					<el-input  v-model.number="ruleForm.huodongrenshu" placeholder="活动人数" clearable  :readonly="ro.huodongrenshu"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="活动人数" prop="huodongrenshu">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-if="type!='info'"  label="活动详情" prop="huodongxiangqing">
					<editor 
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else-if="ruleForm.huodongxiangqing" label="活动详情" prop="huodongxiangqing">
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.huodongxiangqing = this.ruleForm.huodongxiangqing.replace(reg,'../../../php4g28oogo/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
	...
	if(this.ruleForm.fengmian!=null) {
      ...
      if(this.ruleForm.kaishishijian>this.ruleForm.jieshushijian){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `jianglihuodong/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.jianglihuodongCrossAddOrUpdateFlag = false;
						 this.parent.search();
