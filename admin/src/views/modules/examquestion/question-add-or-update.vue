<template>
  <div :style='{"padding":"20px 30px 30px","fontSize":"14px","color":"#666","background":"none","height":"100%"}'>
    <el-form
      ...
      label-width="150px"
    >
      <el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' label="选择考试评估" prop="paperid">
        <el-select @change="onPaperChange" v-model="ruleForm.paperid" placeholder="选择考试评估">
          <el-option
      ...
      <el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' label="试题" prop="questionname">
        <el-input
          type="textarea"
          min="1"
      ...
      <el-form-item :style='{"padding":"0","margin":"30px 0","alignItems":"center","textAlign":"center","display":"flex","width":"100%","fontSize":"48px","justifyContent":"center"}'>
		<el-button class="btn3" :style='{"border":"0px solid rgba(126, 96, 16, .2)","cursor":"pointer","padding":"0 20px","margin":"0px 4px","outline":"none","color":"#fff","borderRadius":"3px","background":"#e0a800","width":"auto","fontSize":"16px","lineHeight":"24px","height":"40px"}' type="success" @click="onSubmit">
			<span class="icon iconfont icon-tijiao16" :style='{"color":"inherit","margin":"0 2px","fontSize":"18px"}'></span>
			确定
		</el-button>
		<el-button class="btn4" :style='{"border":"0px solid rgba(126, 96, 16, .2)","cursor":"pointer","padding":"0 20px","margin":"0px 4px","outline":"none","color":"#fff","borderRadius":"3px","background":"#ff518a","width":"auto","fontSize":"16px","lineHeight":"24px","height":"40px"}' type="success" @click="back()">
...
export default {
  data() {
    ...
    return {
      ...
      rules: {
        paperid: [{ required: true, message: "请选择考试评估", trigger: "blur" }],
        questionname: [
