  ...
  <div :style='{"padding":"20px 30px 30px","fontSize":"14px","color":"#666","background":"none","height":"100%"}'>
    ...
    >  
     <el-row>
        ...
        <el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}'   v-if="flag=='yonghu'"  label="积分" prop="jifen">
        ...
        <el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}'   v-if="flag=='yonghu'"  label="学习目标" prop="xueximubiao">
          <el-input v-model="ruleForm.xueximubiao"               placeholder="学习目标" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}'   v-if="flag=='yonghu'"  label="学习经历" prop="xuexijingli">
          <el-input v-model="ruleForm.xuexijingli"               placeholder="学习经历" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}'   v-if="flag=='yonghu'"  label="兴趣爱好" prop="xingquaihao">
          <el-input v-model="ruleForm.xingquaihao"               placeholder="兴趣爱好" clearable></el-input>
        </el-form-item>
